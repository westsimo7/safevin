...
import { 
  ImagePlus, X, Camera, Tag, DollarSign, Shirt, Palette, 
  Clock, FileText, Layers, Sparkles
} from "lucide-react";
    ...
    <Card className="border-border/50">
      <CardHeader>
        ...
        <p className="text-sm text-muted-foreground">
          Più dettagli inserisci, più precisa sarà l'analisi.
        </p>
      </CardHeader>
        ...
        <div className="grid md:grid-cols-2 gap-4">
          ...
          <div className="md:col-span-2">
            ...
            <Textarea
              ...
              placeholder="Inserisci la descrizione completa del tuo annuncio..."
          ...
          <div>
            ...
            <Input
              ...
              placeholder="Es: Scarpe, Felpe, Pantaloni..."
              className="bg-background border-border"
            />
          </div>
          ...
          <div>
            ...
            <Input
              ...
              placeholder="Es: Nuovo con etichetta, Usato poco..."
              className="bg-background border-border"
            />
          </div>
