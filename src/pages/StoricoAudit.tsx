...
import { Sparkles, ArrowLeft, ArrowRight, Search, Trash2 } from "lucide-react";
      ...
      <main className="container mx-auto px-6 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-muted-foreground">
            Ogni SafeScore™ tracciato. Confronta, monitora, migliora.
          </p>
        ...
        {loading ? (
          ...
          <div className="text-center text-muted-foreground">Nessun Audit ancora. Avvia il primo per ottenere il tuo SafeScore™.</div>
        ) : (
              ...
              {analyses.map((analysis) => (
                ...
                >
                  <CardContent className="p-0 relative">
                    ...
                    <div className="p-4">
                      <h3 className="font-semibold text-sm truncate mb-1">{analysis.titolo || "Annuncio senza titolo"}</h3>
