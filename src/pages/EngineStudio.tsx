...
const EngineStudio = () => {
  ...
  return (
    <div className="flex flex-col flex-1 overflow-hidden bg-background">
      ...
      <main className={`flex-1 overflow-x-hidden px-4 sm:px-6 lg:px-56 xl:px-96 pt-4 sm:pt-6 pb-6 sm:pb-8 ${phase === "upload" || phase === "missing" ? "overflow-hidden flex flex-col" : "overflow-y-auto"}`}>
        {phase === "upload" && (
