    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 md:px-6 pt-4 md:pt-8 pb-8 md:pb-12">
        ...
        <div className="grid grid-cols-2 gap-2 md:gap-6 max-w-3xl mx-auto">
          ...
          >
            <CardContent className="p-2.5 md:p-8 text-center">
              <div className="w-7 h-7 md:w-16 md:h-16 rounded-lg md:rounded-2xl bg-primary/10 flex items-center justify-center mx-auto mb-1.5 md:mb-5 group-hover:scale-110 transition-transform">
                <Search className="w-3.5 h-3.5 md:w-8 md:h-8 text-primary" />
              </div>
              <h2 className="text-xs md:text-2xl font-bold mb-0.5 md:mb-3">ANALIZZA</h2>
          ...
          >
            <CardContent className="p-2.5 md:p-8 text-center">
              <div className="w-7 h-7 md:w-16 md:h-16 rounded-lg md:rounded-2xl bg-primary/10 flex items-center justify-center mx-auto mb-1.5 md:mb-5 group-hover:scale-110 transition-transform">
                <PenTool className="w-3.5 h-3.5 md:w-8 md:h-8 text-primary" />
              </div>
              <h2 className="text-xs md:text-2xl font-bold mb-0.5 md:mb-3">CREA</h2>
              <p className="text-[9px] md:text-sm text-muted-foreground leading-tight">
