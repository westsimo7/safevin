  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "pro-glow": {
          "0%, 40%, 100%": { boxShadow: "0 0 0 hsl(var(--primary) / 0)" },
          "55%, 65%": { boxShadow: "0 0 60px hsl(var(--primary) / 0.7), 0 0 20px hsl(var(--primary) / 0.5)" },
        },
        "fade-in": {
      ...
      animation: {
        ...
        "pro-glow": "pro-glow 24s ease-in-out infinite",
