  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "pro-glow": {
          "0%, 100%": { boxShadow: "0 0 24px hsl(var(--primary) / 0.35), 0 0 8px hsl(var(--primary) / 0.25)" },
          "50%": { boxShadow: "0 0 56px hsl(var(--primary) / 0.65), 0 0 18px hsl(var(--primary) / 0.45)" },
        },
        "fade-in": {
      ...
      animation: {
        ...
        "pro-glow": "pro-glow 2.4s ease-in-out infinite",
